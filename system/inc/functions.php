...
function page404 ()
{
	...
	if ( !file_exists( APP_PAGE_PATH. '404.php' ) )
	{

		# Check if there's a 404.html file in application directory
		if ( !file_exists( APP_PAGE_PATH. '404.html' ) )
		{
			# Include System 404
			include ( BASE_PAGE_PATH.'404.php' );
			exit;
		...
		else
		{
			...
			include ( APP_PAGE_PATH.'404.html' );
			exit;
