...
function redirect_canonical( $requested_url = null, $do_redirect = true ) {
	...
	if ( !$requested_url ) {
		...
		$requested_url .= $_SERVER['REQUEST_PATH'];
	}
	...
	// Some PHP setups turn requests for / into /index.php in REQUEST_PATH
...
function wp_redirect_admin_locations() {
	...
	if ( in_array( untrailingslashit( $_SERVER['REQUEST_PATH'] ), $admins ) ) {
	...
	if ( in_array( untrailingslashit( $_SERVER['REQUEST_PATH'] ), $logins ) ) {
