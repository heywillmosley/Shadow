...
function spawn_cron( $gmt_time = 0 ) {
	...
	*/
	...
	if ( defined('ALTERNATE_WP_CRON') && ALTERNATE_WP_CRON ) {
		...
		ob_start();
		wp_redirect( add_query_arg('doing_wp_cron', $doing_wp_cron, stripslashes($_SERVER['REQUEST_PATH'])) );
		echo ' ';
...
function wp_cron() {
	...
	if ( strpos($_SERVER['REQUEST_PATH'], '/wp-cron.php') !== false || ( defined('DISABLE_WP_CRON') && DISABLE_WP_CRON ) )
		return;
