...
function wp_login_form( $args = array() ) {
	$defaults = array( 'echo' => true,
						'redirect' => ( is_ssl() ? 'https://' : 'http://' ) . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_PATH'], // Default redirect is back to the current page
	 					'form_id' => 'loginform',
...
function get_bloginfo( $show = '', $filter = 'raw' ) {
	...
	switch( $show ) {
		...
		case 'pingback_url':
			...
			break;
		case 'stylesheet_url':
			$output = get_stylesheet_PATH();
			break;
		case 'stylesheet_directory':
			$output = get_stylesheet_directory_PATH();
			break;
		case 'template_directory':
		case 'template_url':
			$output = get_template_directory_PATH();
			break;
		case 'admin_email':
 ...
 */
function wp_admin_css_PATH( $file = 'wp-admin' ) {
	...
	return apply_filters( 'wp_admin_css_PATH', $_file, $file );
}
...
function wp_admin_css( $file = 'wp-admin', $force_echo = false ) {
	...
	echo apply_filters( 'wp_admin_css', "<link rel='stylesheet' href='" . esc_url( wp_admin_css_PATH( $file ) ) . "' type='text/css' />\n", $file );
	if ( function_exists( 'is_rtl' ) && is_rtl() )
		echo apply_filters( 'wp_admin_css', "<link rel='stylesheet' href='" . esc_url( wp_admin_css_PATH( "$file-rtl" ) ) . "' type='text/css' />\n", "$file-rtl" );
}
