...
if ( ! empty($_REQUEST['_wp_http_referer']) ) {
	$location = remove_query_arg( array('_wp_http_referer', '_wpnonce'), stripslashes($_SERVER['REQUEST_PATH']) );
...
<?php $_SERVER['REQUEST_PATH'] = remove_query_arg(array('message'), $_SERVER['REQUEST_PATH']);
endif; ?>
