...
class Custom_Image_Header {
	...
	function process_default_headers() {
		...
		$template_directory_PATH = get_template_directory_PATH();
		$stylesheet_directory_PATH = get_stylesheet_directory_PATH();
		foreach ( array_keys($this->default_headers) as $header ) {
			$this->default_headers[$header]['url'] =  sprintf( $this->default_headers[$header]['url'], $template_directory_PATH, $stylesheet_directory_PATH );
			$this->default_headers[$header]['thumbnail_url'] =  sprintf( $this->default_headers[$header]['thumbnail_url'], $template_directory_PATH, $stylesheet_directory_PATH );
		}
