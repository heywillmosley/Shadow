...
$_SERVER['REQUEST_PATH'] = remove_query_arg(array('error', 'deleted', 'activate', 'activate-multi', 'deactivate', 'deactivate-multi', '_error_nonce'), $_SERVER['REQUEST_PATH']);
	...
	switch ( $action ) {
		...
		case 'delete-selected':
			...
			<div class="wrap">
				...
				?></p>
				<form method="post" action="<?php echo esc_url($_SERVER['REQUEST_PATH']); ?>" style="display:inline;">
