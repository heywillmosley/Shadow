...
if ( $doaction ) {
	...
	exit;
	 ...
	 wp_redirect( remove_query_arg( array( '_wp_http_referer', '_wpnonce' ), stripslashes( $_SERVER['REQUEST_PATH'] ) ) );
	 exit;
}
...
if ( ! empty( $_GET['posted'] ) ) {
	...
	$_SERVER['REQUEST_PATH'] = remove_query_arg(array('posted'), $_SERVER['REQUEST_PATH']);
}

if ( ! empty( $_GET['attached'] ) && $attached = absint( $_GET['attached'] ) ) {
	$message = sprintf( _n('Reattached %d attachment.', 'Reattached %d attachments.', $attached), $attached );
	$_SERVER['REQUEST_PATH'] = remove_query_arg(array('attached'), $_SERVER['REQUEST_PATH']);
}
...
if ( ! empty( $_GET['deleted'] ) && $deleted = absint( $_GET['deleted'] ) ) {
	...
	$_SERVER['REQUEST_PATH'] = remove_query_arg(array('deleted'), $_SERVER['REQUEST_PATH']);
}
...
if ( ! empty( $_GET['trashed'] ) && $trashed = absint( $_GET['trashed'] ) ) {
	...
	$_SERVER['REQUEST_PATH'] = remove_query_arg(array('trashed'), $_SERVER['REQUEST_PATH']);
}
...
if ( ! empty( $_GET['untrashed'] ) && $untrashed = absint( $_GET['untrashed'] ) ) {
	...
	$_SERVER['REQUEST_PATH'] = remove_query_arg(array('untrashed'), $_SERVER['REQUEST_PATH']);
}
...
if ( ! empty( $_GET['message'] ) && isset( $messages[ $_GET['message'] ] ) ) {
	...
	$_SERVER['REQUEST_PATH'] = remove_query_arg(array('message'), $_SERVER['REQUEST_PATH']);
}
