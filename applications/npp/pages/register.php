 ...
 * King Bio, Inc
 *
 * King Bio offers the only pure water based homeopathics in the industry.
 *
 * @package        Dr Kings Natural Medicine
 * @author         King Bio, Inc
 * @copyright      Copyright (c) 2013, King Bio, Inc
 * @license        
 * @link           http://kingbio.com
 * @since          Version 1.0.0
 * @filesource     /html/applications/dknm/pages/register.php
 */
