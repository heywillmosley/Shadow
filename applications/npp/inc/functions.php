...
# App Header @since 1.1.5
function app_header ()
{
	global $dbc, $page, $page_title;
	require_once( APPPATH.'/inc/header.php');
	
} // end app_header

# App Footer @since 1.1.5
function app_footer ()
{
	global $dbc, $page;
	require_once( APPPATH.'/inc/footer.php');
	
} // end app_header

# Validate Login Attempts @since 1.1.5
...
/* Secure Session Start @since 1.1.5
 *
