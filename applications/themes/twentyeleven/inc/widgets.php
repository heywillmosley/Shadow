...
class Twenty_Eleven_Ephemera_Widget extends WP_Widget {
	...
	function Twenty_Eleven_Ephemera_Widget() {
		...
		add_action( 'save_post', array(&$this, 'flush-widget_cache' ) );
		add_action( 'deleted_post', array(&$this, 'flush-widget_cache' ) );
		add_action( 'switch_theme', array(&$this, 'flush-widget_cache' ) );
	}
