...
function twentyeleven_admin_enqueue_scripts( $hook_suffix ) {
	wp_enqueue_style( 'twentyeleven-theme-options', get_template_directory_PATH() . '/inc/theme-options.css', false, '2011-04-28' );
	wp_enqueue_script( 'twentyeleven-theme-options', get_template_directory_PATH() . '/inc/theme-options.js', array( 'farbtastic' ), '2011-06-10' );
...
function twentyeleven_color_schemes() {
	$color_scheme_options = array(
		'light' => array(
			...
			'thumbnail' => get_template_directory_PATH() . '/inc/images/light.png',
			'default_link_color' => '#1b8be0',
		),
		'dark' => array(
			'value' => 'dark',
			'label' => __( 'Dark', 'twentyeleven' ),
			'thumbnail' => get_template_directory_PATH() . '/inc/images/dark.png',
...
function twentyeleven_layouts() {
	$layout_options = array(
		'content-sidebar' => array(
			...
			'thumbnail' => get_template_directory_PATH() . '/inc/images/content-sidebar.png',
		),
		'sidebar-content' => array(
			'value' => 'sidebar-content',
			'label' => __( 'Content on right', 'twentyeleven' ),
			'thumbnail' => get_template_directory_PATH() . '/inc/images/sidebar-content.png',
		),
		'content' => array(
			'value' => 'content',
			'label' => __( 'One-column, no sidebar', 'twentyeleven' ),
			'thumbnail' => get_template_directory_PATH() . '/inc/images/content.png',
		),
	);
...
function twentyeleven_enqueue_color_scheme() {
	...
	if ( 'dark' == $color_scheme )
		wp_enqueue_style( 'dark', get_template_directory_PATH() . '/colors/dark.css', array(), null );
...
function twentyeleven_customize_preview_js() {
	wp_enqueue_script( 'twentyeleven-customizer', get_template_directory_PATH() . '/inc/theme-customizer.js', array( 'customize-preview' ), '20120523', true );
}
